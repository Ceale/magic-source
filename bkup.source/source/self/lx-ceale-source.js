/**
 * @name Ceale's LX-Source By Zxwy
 * @description 运行在Ceale的Zxwy编写的LX-Source
 * version 1.0.0
 * @author Ceale (By Zxwy)
 */

// 脚本配置
const version = '1.0.3' // 脚本版本
const apiaddr = 'http://47.116.202.179:10128/' // 服务端地址，末尾加斜杠
const apipass = 'w8E0lDN/3bMmB9CFKJkclg==' // 验证密钥，填在单引号内
